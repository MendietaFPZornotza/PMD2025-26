...
/**
 * Fitxategia: KontzertuakActivity.kt
 *
 * Zertarako da?
 * - Kontzertu zerrenda erakusteko pantaila (activity_list layout komuna).
 *
 * Zer egiten du?
 ...
 */
class KontzertuakActivity : AppCompatActivity(), MenuListController.View {

    companion object {
        private const val TAG = "KontzertuakActivity"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i(TAG, "onCreate(): KontzertuakActivity")
    ...
    override fun setFilterButtonText(text: String) {
        Log.d(KontzertuakActivity.Companion.TAG, "setFilterButtonText(): $text")
        filterLabel = text
        btnFilter.text = text
    }
    ...
    override fun setLoading(loading: Boolean) {
        Log.d(KontzertuakActivity.Companion.TAG, "setLoading(): $loading")
